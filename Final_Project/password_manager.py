...
# ---------------------------------------------- CONSTANTS SECTION -------------------------------------- #
CANVAS_BACKGROUND_COLOR = "#0a3d4c"
INPUT_FIELD_COLORS = "#e7e6e1"
TEXT_COLOR = "#f8f7f7"
SEARCH_BUTTON_COLOR = "#5ec7d1"
ADD_BUTTON_COLOR = "#5ece5c"
GENERATE_BUTTON_COLOR = "#e2d424"
HIGHLIGHT_COLOR = "#c88c16"
